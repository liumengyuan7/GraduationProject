...
public class LaughAdapter extends  RecyclerView.Adapter<LaughAdapter.ViewHolder>  {
    ...
    @NonNull
    @Override
    public LaughAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LaughAdapter.ViewHolder holder, int position) {
